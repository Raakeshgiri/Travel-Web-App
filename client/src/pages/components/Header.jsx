...
const Header = () => {
  ...
  return (
    <>
      <div className="bg-black p-4 px-8 flex justify-between items-center">
        {/* <h1
        ...
        <h1 className="font-bold text-2xl text-white">Travellers</h1>
        <ul className="flex flex-wrap items-center justify-end gap-x-8 text-white font-semibold list-none">
